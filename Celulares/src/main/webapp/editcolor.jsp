<%-- 
    Document   : editmark
    Created on : 15 jul. 2020, 12:34:48
    Author     : Light
--%>
...
<%
    ...
    flag = color.edit(new color( Integer.parseInt(request.getParameter("id_color")), request.getParameter("color")));
