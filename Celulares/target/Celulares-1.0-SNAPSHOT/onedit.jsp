<%-- 
    Document   : onedit
    Created on : 15 jul. 2020, 9:55:41
    Author     : Light
--%>
...
<%
    ...
    flag = producto.Edit( new producto(request.getParameter("Nombre"), Integer.parseInt(request.getParameter("Modelo")), Integer.parseInt(request.getParameter("Colores")), request.getParameter("Marca"), Double.parseDouble(request.getParameter("precio")), Integer.parseInt(request.getParameter("id_celular"))));
...
<body>
     <%
        if(flag=true){ 
        almacen.Update(new almacen( Integer.parseInt(request.getParameter("id_celular")), Integer.parseInt(request.getParameter("cantidad"))));
        %>
